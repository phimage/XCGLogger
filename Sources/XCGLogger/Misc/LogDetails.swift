...
public struct LogDetails {
    ...
    public var userInfo: UserInfoConvertibleProtocol

    public init(level: XCGLogger.Level, date: Date, message: String, functionName: String, fileName: String, lineNumber: Int, userInfo: UserInfoConvertibleProtocol = [:]) {
        self.level = level
        self.date = date
